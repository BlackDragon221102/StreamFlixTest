...
class TvShowsMobileFragment : Fragment(), TopLevelTabFragment {
    ...
    private fun consumePendingTopLevelScrollResetIfNeeded() {
        ...
        if (mainActivity?.hasPendingTopLevelScrollReset(R.id.tv_shows) == true) {
            pendingTopLevelScrollToTop = true
        }
        ...
        mainActivity?.consumePendingTopLevelScrollReset(R.id.tv_shows)
        scrollToTop()
    }
