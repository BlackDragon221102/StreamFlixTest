...
object CatalogRefreshUtils {
    const val HOME_CACHE_KEY = "mobile_home_categories_v2"
    const val MOVIES_CACHE_KEY = "mobile_movies_categories_v3"
    const val TV_CACHE_KEY = "mobile_tv_categories_v3"
